...
```
Return is used to run functions and values. Console.log will print what you want to the console.
```

**_What's the difference between defining and calling a function?_**

```
Defining functions is when you give it a name and set it up. Calling it is when you add parameters you want to return.
```
...
```
A string is a word or words wrapped in quotes in your code.
```

**_Number_**

```
A number must be a whole number and doesn't need quotes.
```

**_Boolean_**

```
A boolean is a true of false condition.
```
